...
const _c0 = ["*"]; // https://jasonwatmore.com/post/2019/04/16/angular-7-custom-modal-window-dialog-box
...
let ModalComponent = /*#__PURE__*/(() => {
  class ModalComponent {
    ...
    ngOnInit() {
      let modal = this; // ensure id attribute exists
  ...
  ModalComponent.ɵfac = function ModalComponent_Factory(t) {
    return new (t || ModalComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_modal_service__WEBPACK_IMPORTED_MODULE_0__.ModalService), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__.ElementRef));
  };
...
let AjaxService = /*#__PURE__*/(() => {
  ...
  AjaxService.ɵfac = function AjaxService_Factory(t) {
    return new (t || AjaxService)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient));
  };

  AjaxService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineInjectable"]({
    token: AjaxService,
    factory: AjaxService.ɵfac,
    providedIn: 'root'
  });
  return AjaxService;
})();
...
let CategoriesService = /*#__PURE__*/(() => {
  class CategoriesService extends _ajax_service__WEBPACK_IMPORTED_MODULE_0__.AjaxService {
    ...
    get(params) {
      return new Promise((resolve, reject) => {
        if (this.items[params.idDictionary] && this.items[params.idDictionary][params.id]) {
          ...
          this._get(this.route + params.idDictionary + '/' + params.id).subscribe(item => {
            if (item) {
    ...
    getAll(params) {
      return new Promise((resolve, reject) => {
        if (this.hasAll[params.idDictionary]) {
          ...
          this._get(this.route + params.idDictionary + '/').subscribe(items => {
    ...
    add(params) {
      return new Promise((resolve, reject) => {
        this._post(this.route + params.idDictionary + '/', params.category).subscribe(item => {
          if (item) {
            this.set([item], params.idDictionary);
            resolve(item);
          } else {
    ...
    update(params) {
      return new Promise((resolve, reject) => {
        this._put(this.route + params.idDictionary + '/' + params.id, params.category).subscribe(item => {
          if (item) {
            this.set([item], params.idDictionary);
            resolve(item);
          } else {
    ...
    delete(params) {
      return new Promise((resolve, reject) => {
        this._delete(this.route + params.idDictionary + '/' + params.id).subscribe(item => {
          if (item) {
  ...
  CategoriesService.ɵfac = /*@__PURE__*/function () {
    ...
    return function CategoriesService_Factory(t) {
      return (ɵCategoriesService_BaseFactory || (ɵCategoriesService_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetInheritedFactory"](CategoriesService)))(t || CategoriesService);
    };
  }();

  CategoriesService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
...
let ChaptersService = /*#__PURE__*/(() => {
  class ChaptersService extends _ajax_service__WEBPACK_IMPORTED_MODULE_0__.AjaxService {
    ...
    has(params) {
      if (!params.no) {
        ...
        if (!params.text) {
          ...
          return !!(this.items[params.idNovel] && this.items[params.idNovel][params.no] && this.items[params.idNovel][params.no].textOriginal);
        }
      }
    }
    /**
    ...
    get(params) {
      return new Promise((resolve, reject) => {
        if (this.has({
          idNovel: params.idNovel,
          no: params.no,
          text: params.text
        })) {
          resolve(this.items[params.idNovel][params.no]);
        } else {
          this._get(this.route + params.idNovel + '/' + params.no).subscribe(item => {
            if (item) {
    ...
    getAll(params) {
      return new Promise((resolve, reject) => {
        if (this.hasAll[params.idNovel]) {
          ...
          this._get(this.route + params.idNovel).subscribe(items => {
            if (items.length > 0) {
    ...
    add(params) {
      return new Promise((resolve, reject) => {
        this._post(this.route, params.chapter).subscribe(item => {
          if (item) {
            this.set(params.idNovel, [item]);
            resolve(item);
          } else {
    ...
    update(params) {
      return new Promise((resolve, reject) => {
        this._put(this.route + params.idNovel + '/' + params.no, params.chapter).subscribe(item => {
          if (item) {
            this.set(params.idNovel, [item]);
            resolve(item);
          } else {
    ...
    delete(params) {
      return new Promise((resolve, reject) => {
        this._delete(this.route + params.idNovel + '/' + params.no).subscribe(item => {
          if (item) {
    ...
    autoUpdate(params) {
      return new Promise((resolve, reject) => {
        this._get(this.route + 'autoUpdate/' + params.idNovel).subscribe(novel => {
          // If we already have a register, we should check if anything relevant was updated.
          if (this.api.Novel.has({
            id: params.idNovel
          })) {
            this.api.Novel.get({
              id: params.idNovel
              ...
              if (novel.numberChapters !== novelCurrent.numberChapters) {
                ...
                this.hasAll[params.idNovel] = false; //  Then if we already have chapters in, we reload, otherwise, no need to do that.
  ...
  ChaptersService.ɵfac = /*@__PURE__*/function () {
    let ɵChaptersService_BaseFactory;
    return function ChaptersService_Factory(t) {
      return (ɵChaptersService_BaseFactory || (ɵChaptersService_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetInheritedFactory"](ChaptersService)))(t || ChaptersService);
    };
  }();

  ChaptersService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
    token: ChaptersService,
    factory: ChaptersService.ɵfac,
    providedIn: 'root'
  });
...
let DictionariesService = /*#__PURE__*/(() => {
  class DictionariesService extends _ajax_service__WEBPACK_IMPORTED_MODULE_1__.AjaxService {
      ...
      if (params.id) {
        return new Promise((resolve, reject) => {
          if (this.items[params.id]) {
            ...
            this._get(this.route + params.id).subscribe(item => {
              if (item) {
                this.set([item]);
                resolve(item);
              } else {
    ...
    getAll(params) {
      return new Promise((resolve, reject) => {
        ...
        } else // If we are looking only for all Dictionaries, we do it here
          if (this.hasAll && !idNovel) {
            resolve(this.items);
          } else {
            this._get(this.route + (idNovel ? 'novel/' + idNovel : '')).subscribe(items => {
              if (items.length > 0) {
                this.set(items, idNovel); // Here we also set the different paths
    ...
    add(params) {
      return new Promise((resolve, reject) => {
        this._post(this.route, params.values).subscribe(item => {
          if (item) {
            this.set([item]);
            resolve(item);
          } else {
    ...
    update(params) {
      return new Promise((resolve, reject) => {
        this._put(this.route + params.id, params.values).subscribe(item => {
          if (item) {
            this.set([item]);
            resolve(item);
          } else {
    ...
    delete(params) {
      return new Promise((resolve, reject) => {
        this._delete(this.route + params.id).subscribe(item => {
          if (item) {
    ...
    getCache(idDictionary) {
      return new Promise((resolve, reject) => {
        if (this.hasCache[idDictionary]) {
          ...
          this._get('cache/dictionary/' + idDictionary).subscribe(cache => {
    ...
    rebuildCache(idDictionary) {
      return new Promise((resolve, reject) => {
        this._put('cache/dictionary/' + idDictionary).subscribe(cache => {
          this.hasCache[idDictionary] = true;
          this.reworkCache(cache);
          resolve(true);
        });
    ...
    fullSave(idDictionary, categories) {
      return new Promise((resolve, reject) => {
        this._put('dictionary/fullSave/' + idDictionary, categories).subscribe(returnFS => {
          if (returnFS.changes) {
  ...
  DictionariesService.ɵfac = /*@__PURE__*/function () {
    let ɵDictionariesService_BaseFactory;
    return function DictionariesService_Factory(t) {
      return (ɵDictionariesService_BaseFactory || (ɵDictionariesService_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵgetInheritedFactory"](DictionariesService)))(t || DictionariesService);
    };
  }();

  DictionariesService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({
...
let EntriesService = /*#__PURE__*/(() => {
  class EntriesService extends _ajax_service__WEBPACK_IMPORTED_MODULE_1__.AjaxService {
    ...
    has(params) {
      if (!params.id) {
        ...
        return !!(this.items[params.idDictionary] && this.items[params.idDictionary][params.idCategory] && this.items[params.idDictionary][params.idCategory][params.id]);
      }
    }
    /**
     * Basic CRUD stuff here
    ...
    get(params) {
      return new Promise((resolve, reject) => {
        if (this.items[params.idDictionary] && this.items[params.idDictionary][params.idCategory] && this.items[params.idDictionary][params.idCategory][params.id]) {
    ...
    getAll(params) {
      return new Promise((resolve, reject) => {
        if (this.hasAll[params.idDictionary] && this.hasAll[params.idDictionary][params.idCategory]) {
          resolve(this.items[params.idDictionary][params.idCategory]);
        } else {
          this._get(this.route + [params.idDictionary, params.idCategory].join('/')).subscribe(items => {
            if (items.length >= 0) {
    ...
    add(params) {
      return new Promise((resolve, reject) => {
        this._post(this.route, params.entry).subscribe(item => {
          if (item) {
            this.set(params.idDictionary, params.idCategory, [item]);
            resolve(item);
          } else {
    ...
    update(params) {
      return new Promise((resolve, reject) => {
        this._put(this.route + params.id, params.entry).subscribe(item => {
          if (item) {
            this.set(params.idDictionary, params.idCategory, [item]);
            resolve(item);
          } else {
    ...
    saveByCategory(params) {
      return new Promise((resolve, reject) => {
        this._put(this.route + [params.idDictionary, 'updatebycategory', params.idCategory].join('/'), params.entries).subscribe(items => {
          if (items) {
            /**
  ...
  EntriesService.ɵfac = /*@__PURE__*/function () {
    let ɵEntriesService_BaseFactory;
    return function EntriesService_Factory(t) {
      return (ɵEntriesService_BaseFactory || (ɵEntriesService_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵgetInheritedFactory"](EntriesService)))(t || EntriesService);
    };
  }();

  EntriesService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({
    token: EntriesService,
    factory: EntriesService.ɵfac,
    providedIn: 'root'
  });
...
let MetaService = /*#__PURE__*/(() => {
  ...
  MetaService.ɵfac = /*@__PURE__*/function () {
    let ɵMetaService_BaseFactory;
    return function MetaService_Factory(t) {
      return (ɵMetaService_BaseFactory || (ɵMetaService_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetInheritedFactory"](MetaService)))(t || MetaService);
    };
  }();
...
let NovelsService = /*#__PURE__*/(() => {
    ...
    getAll(params) {
      return new Promise((resolve, reject) => {
        ...
        if (idDictionary && this.hasAllDictionaries[idDictionary]) {
          ...
          this._get(this.route + (idDictionary ? 'dictionary/' + idDictionary : '')).subscribe(items => {
            this.set(items, idDictionary); // Here we also set the different paths
  ...
  NovelsService.ɵfac = /*@__PURE__*/function () {
    let ɵNovelsService_BaseFactory;
    return function NovelsService_Factory(t) {
      return (ɵNovelsService_BaseFactory || (ɵNovelsService_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetInheritedFactory"](NovelsService)))(t || NovelsService);
    };
  }();

  NovelsService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
    token: NovelsService,
    factory: NovelsService.ɵfac,
    providedIn: 'root'
  });
...
const routes = [{
  path: 'dashboard',
  loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_dashboard_index_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./dashboard */ 96998)).then(m => m.DashboardModule),
  data: {
    title: 'Dashboard',
  ...
  path: 'novel',
  loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app__models_formField_ts"), __webpack_require__.e("src_app_novel_index_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./novel */ 42314)).then(m => m.NovelModule),
  data: {
    title: 'List Novels',
    breadcrumb: 'Novels'
  }
  ...
  path: 'dictionary',
  loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_dictionary_index_ts"), __webpack_require__.e("default-src_app__models_formField_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./dictionary */ 84341)).then(m => m.DictionaryModule),
  data: {
...
let AppComponent = /*#__PURE__*/(() => {
  ...
  AppComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
    ...
    styles: [".container[_ngcontent-%COMP%] {\n  width: 100%;\n  max-width: 100% !important;\n  top: 100px;\n  position: absolute;\n  overflow-y: auto;\n  overflow-x: hidden;\n  height: calc(100% - 101px);\n}\n\nbody[_ngcontent-%COMP%] {\n  overflow-y: hidden;\n}\n/*# sourceMappingURL=data:application/json;base64, */", "jw-modal[_ngcontent-%COMP%] {\n  \n  display: none;\n}\njw-modal[_ngcontent-%COMP%]   .jw-modal[_ngcontent-%COMP%] {\n  \n  position: fixed;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  \n  z-index: 1000;\n  \n  overflow: auto;\n}\njw-modal[_ngcontent-%COMP%]   .jw-modal[_ngcontent-%COMP%]   .jw-modal-body[_ngcontent-%COMP%] {\n  padding: 20px 50px;\n  background: #fff;\n  \n  margin: 40px;\n}\njw-modal[_ngcontent-%COMP%]   .jw-modal-background[_ngcontent-%COMP%] {\n  \n  position: fixed;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  \n  background-color: #000;\n  opacity: 0.75;\n  \n  z-index: 900;\n}\nbody.jw-modal-open[_ngcontent-%COMP%] {\n  \n  overflow: hidden;\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
  });
  return AppComponent;
})();
...
/* harmony import */ var ng_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ng-keyboard-shortcuts */ 14740);
...
/* harmony import */ var _pipes_safe_html_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./_pipes/safe-html.pipe */ 25979);
...
let AppModule = /*#__PURE__*/(() => {
  ...
  AppModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineInjector"]({
    providers: [_services_modal_modal_component__WEBPACK_IMPORTED_MODULE_3__.ModalComponent],
    imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_8__.BrowserModule, _app_routing_module__WEBPACK_IMPORTED_MODULE_0__.AppRoutingModule, _angular_common_http__WEBPACK_IMPORTED_MODULE_9__.HttpClientModule, _angular_forms__WEBPACK_IMPORTED_MODULE_10__.FormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_10__.ReactiveFormsModule, _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_11__.FontAwesomeModule, //Papa,    // Necessary for CSV
    ng_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_12__.KeyboardShortcutsModule.forRoot(), _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_13__.BrowserAnimationsModule]]
  });
  return AppModule;
})();
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵsetNgModuleScope"](AppModule, {
    declarations: [_app_component__WEBPACK_IMPORTED_MODULE_1__.AppComponent, _header_header_component__WEBPACK_IMPORTED_MODULE_2__.HeaderComponent, _pipes_safe_html_pipe__WEBPACK_IMPORTED_MODULE_5__.SafeHtmlPipe],
    imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_8__.BrowserModule, _app_routing_module__WEBPACK_IMPORTED_MODULE_0__.AppRoutingModule, _angular_common_http__WEBPACK_IMPORTED_MODULE_9__.HttpClientModule, _angular_forms__WEBPACK_IMPORTED_MODULE_10__.FormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_10__.ReactiveFormsModule, _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_11__.FontAwesomeModule, ng_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_12__.KeyboardShortcutsModule, _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_13__.BrowserAnimationsModule]
  });
})();
...
function HeaderComponent_ng_container_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "li", 3)(2, "a");
...
let HeaderComponent = /*#__PURE__*/(() => {
  class HeaderComponent {
    ...
    ngOnInit() {
      this.router.events.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.filter)(event => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__.NavigationEnd), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.distinctUntilChanged)()).subscribe(next => {
        ...
        this.breadcrumbs = this.buildBreadCrumb(this.activatedRoute.root);
        this.renameLabels(); //console.log('ROUTER END');
      });
    }
          ...
          switch (el.type) {
            ...
            case 'idDictionary':
              this.api.Dictionary.get({
                id: rememberVariables.idDictionary
              }).then(dictionary => {
            ...
            case 'idCategory':
              this.api.Category.get({
                idDictionary: rememberVariables.idDictionary,
                id: rememberVariables.idCategory
              }).then(category => {
            ...
            case 'noChapter':
              this.api.Chapter.get({
                idNovel: rememberVariables.idNovel,
                no: rememberVariables.noChapter
              }).then(chapter => {
  ...
  HeaderComponent.ɵfac = function HeaderComponent_Factory(t) {
    return new (t || HeaderComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__.ActivatedRoute), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_api__WEBPACK_IMPORTED_MODULE_0__.ApiService));
  };
  ...
  HeaderComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
    ...
    decls: 7,
    vars: 1,
    consts: [["src", "assets/mtl_tools.png", "routerLink", "/", 1, "appName"], ["routerLink", "/dashboard", "routerLinkActive", "router-link-active"], [4, "ngFor", "ngForOf"], ["routerLinkActive", "router-link-active", 3, "routerLink"]],
    template: function HeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "header");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](1, "img", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](2, "ul")(3, "li", 1)(4, "a");
    ...
    directives: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterLink, _angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterLinkActive, _angular_common__WEBPACK_IMPORTED_MODULE_5__.NgForOf],
    styles: ["header[_ngcontent-%COMP%] {\n  background: #5e009f;\n  padding: 0px;\n  margin: 0px;\n  height: 100px;\n  cursor: pointer;\n}\nheader[_ngcontent-%COMP%]    > *[_ngcontent-%COMP%] {\n  float: left;\n}\nheader[_ngcontent-%COMP%]    > .appName[_ngcontent-%COMP%] {\n  height: 100%;\n}\nheader[_ngcontent-%COMP%]    > ul[_ngcontent-%COMP%] {\n  list-style: none;\n  height: 100%;\n  padding: 0px;\n  margin: 0px;\n}\nheader[_ngcontent-%COMP%]    > ul[_ngcontent-%COMP%]   li[_ngcontent-%COMP%] {\n  display: block;\n  float: left;\n  margin: 25px 0px 0px 20px;\n  position: relative;\n}\nheader[_ngcontent-%COMP%]    > ul[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  margin: auto;\n  height: 50px;\n  border-radius: 20px 20px 0px 20px;\n  color: #ffffff;\n  width: auto;\n}\nheader[_ngcontent-%COMP%]    > ul[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:after {\n  content: \"\";\n  display: block;\n  width: 0;\n  height: 0;\n  border: 13px solid transparent;\n  border-right-color: inherit;\n  position: absolute;\n  top: 19px;\n  right: -21px;\n  transform: rotate(-135deg);\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
  });
